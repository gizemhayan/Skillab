...
def load_esco_taxonomy(
    ...
    **_kwargs,
    ...
    """Load ESCO skill URIs and labels used by the extraction pipeline.

    Returns:
      - digital_uris: set of conceptUri from the digital sub-collection
      - green_uris: set of conceptUri from the green sub-collection
